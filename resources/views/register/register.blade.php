                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="/dashboard">
                                <img src="images/pertamina.png" alt="" width="320" height="80">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="/register" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="name" placeholder="Username" id="name" @error('name') is-invalid @enderror>
                                </div>
                                <div class="form-group">
